...
export function buildOpenClawToolFallbackText(params: {
  ...
  if (isOpenClawMainPromptSurface(params.surface)) {
    return [
      ...
      "- /schedule, /calendar, /event, /task: scheduling aliases; use cron to create the reminder/event/task from the command text and ask only for missing required fields",
